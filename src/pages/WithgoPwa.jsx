    ...
    return (
        <div className="my-4">
            <div className="flex items-center mb-1">
                <h2 className="text-xl font-bold mb-1">짐이동/보관 PWA버전</h2>
                <span className="ml-1 text-[0.9rem] text-gray-700">(2025.06)</span>
            </div>
            <p className="mb-3 ml-2">React + Express + Supabase 기반 모바일 웹앱, 팀 프로젝트</p>
            <h2 className="text-xl font-bold mb-3">Purpose of making</h2>
            <p className="pl-2">짐이동/보관 사용자 페이지에서 반응형으로 구현해야하나, 프로젝트 기간이 촉박하여 팀원들과 상의 결과 PWA 버전을 따로 만들자고 하여 PWA를 전담하여 제작하게 되었습니다.</p>
            ...
            <p className="pl-2">처음 저는 팀원과 상의할 때 기간이 촉박하더라도 기존에 만든 사용자 웹에서 반응형을 구현해서 PWA를 써야한다 라는 입장이였습니다. 팀원 회의결과 PWA로 가자는 입장이 많아 PWA버전을 따로 만들게 되었습니다. PWA 버전을 만들면서 RestApi도 해보며, 값진 경험을 하였습니다. 처음 교육 받을 때는 어떻게 쓰는거지 했던게 조금씩이나마 이해가 되기 시작했고, 제가 성장하는 밑거름이 된 것 같습니다.</p>
